...
class PCDdataModule(LightningDataModule):
    def __init__(self, set_nr, augmentations, AUGMENT_ON, PRE_PROCESS, PCD_CONFIG, NUM_WORKERS, BATCH_SIZE, trial, EVAL="TSUNAMI"):
        self.set_nr = set_nr
        ...
        self.concat_data_val = ConcatDataset([TSUNAMI_test, GSV_test])
